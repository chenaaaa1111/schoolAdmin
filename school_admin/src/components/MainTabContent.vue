<template>
    <div class="mianTabContent" id="mianTabContent">
        <el-tabs v-model="activeName" @tab-click="handleClick">
                        ...
                        <el-table :data="classData" style="width: 100%" class="tableTh">
                            ...
                            <el-table-column prop="address" label="操作">
                                <template slot-scope="scope">
                                    <span>
                                        <router-link
                                         :to="{path :'/space/item',query:{id:scope.row.id,type:'1',showCheck:scope.row.type==1,url:'/backapi/Management/auditClass'}}"> 查看
                                        </router-link
                                        >
                                    </span>
                                    <span v-show="scope.row.type==1" @click="showChek(scope.row.id)" style="color:  rgb(0, 0, 238);">审核</span>
                                </template>
                            </el-table-column>
                        </el-table>
                    </template>
                    ...
                    <template>
                        ...
                        <el-table :data="classList" style="width: 100%" class="tableTh">
                            ...
                            <el-table-column prop="address" label="操作">
                                <template slot-scope="scope">
                                    <span>
                                        <router-link :to="{path :'/space/item',query:{id:scope.row.id,type:'1',showCheck:scope.row.type==1}}"> 查看
                                        </router-link>
                                    </span>
                                    <span>修改</span>
            ...
            <el-tab-pane label="年级空间" name="gradeSpace">
                <div class="topList">
                    ...
                    <template>
                        <el-table :data="gradeData" style="width: 100%" class="tableTh">
                            ...
                            <el-table-column prop="address" label="操作">
                                <template slot-scope="scope">
                                    <span>
                                        <router-link :to="{path :'/space/item',query:{id:scope.row.id,type:'1',showCheck:scope.row.type=='1',url:'/backapi/Management/auditClass'}}"> 查看
                                        </router-link>
                                    </span>
                                    <span v-show="scope.row.type==1" @click="showChek(scope.row.id)" style="color:  rgb(0, 0, 238);">审核</span>
                                </template>
                        ...
                        <el-table :data="spicialData" style="width: 100%" class="tableTh">
                            ...
                            <el-table-column prop="address" label="操作">
                                <template slot-scope="scope">
                                    <span>
                                        <router-link 
                                        :to="{path :'/space/item',query:{id:scope.row.id,type:'3',showCheck:scope.row.type==1,url:'/backapi/Management/auditClass'}}"> 查看
                                        </router-link>
                                    </span>
                                    <span v-show="scope.row.type==1" @click="showChek(scope.row.id)" style="color:  rgb(0, 0, 238);">审核</span>
                                </template>
                    ...
                    <template>
                        ...
                        <el-table :data="specialList" style="width: 100%" class="tableTh">
                            ...
                            <el-table-column prop="address" label="操作">
                                <template slot-scope="scope">
                                    <span>
                                        <router-link :to="{path :'/space/item',query:{id:scope.row.id,type:'3',showCheck:scope.row.type==1}}"> 查看
                                        </router-link>
                                    </span>
                                    <span>修改</span>
                                    <span @click="deleteArt(scope.id)">删除</span>
